...
/* =========================================================
   ...
   "The CEO wants to see sales performance broken down by
    time periods. Start with yearly total, then quarterly,
    then monthly sales for 2024."
...
/* =========================================================
   ...
   "The product manager needs to identify top-performing
    products. Show the top 10 products by revenue, along
    with their category, total units sold, and revenue
    contribution percentage."

   Includes:
   Revenue percentage calculation using window function
   ========================================================= */
